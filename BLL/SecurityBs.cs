...
namespace BLL
{
    ...
    public class OddhoyonMembershipProvider : MembershipProvider
    {
        UsersDb db;

        public OddhoyonMembershipProvider()
        {
            db = new UsersDb();
        }
    ...
    public class OddhoyonRoleProvider : RoleProvider
    {
        UsersDb db;

        public OddhoyonRoleProvider()
        {
            db = new UsersDb();
        }
        public override string ApplicationName
